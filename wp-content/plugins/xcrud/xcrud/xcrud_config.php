...
{
    // default connection
    public static $dbname = 'tntservice'; // Your database name
    ...
    // editor
    public static $editor_url = 'wp-includes/js/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
